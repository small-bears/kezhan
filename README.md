...
管理员：管理员进入系统主页面，主要功能包括对首页、入住信息管理、客服聊天管理、用户管理、轮播图管理、公告信息管理等进行操作。

用户：当游客打开系统的网址后，首先看到的就是首页界面。在这里，游客能够看到怀旧小筑客栈管理系统的导航条显示系统首页、客栈信息、客栈商品、客栈资讯等。在个人中心页面可以输入个人详细信息，进行修改密码信息等操作，还可以对修改密码、客栈预订、入住信息、商品订单、通知消息、客栈报修、我的收藏进行操作。
